...
def main(unused_argv):
    ...
    if FLAGS.dataset == 'mnist':
        ...
        # Convert to Examples and write the result to TFRecords
        convert_binary_mnist(os.path.join(FLAGS.directory, FLAGS.dataset, 'binarized_mnist_train.amat'),
                             'bin_mnist_train')
        convert_binary_mnist(os.path.join(FLAGS.directory, FLAGS.dataset, 'binarized_mnist_valid.amat'),
                             'bin_mnist_valid')
        convert_binary_mnist(os.path.join(FLAGS.directory, FLAGS.dataset, 'binarized_mnist_test.amat'),
                             'bin_mnist_test')
